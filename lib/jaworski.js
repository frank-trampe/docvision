...
function darkVerticalBlocksFind(img, rules, roi) {
	...
	if (typeof(opts.leftOffsetMin) == "number")
	...
	if (typeof(opts.leftOffsetMax) == "number")
		rowBlackBounds.forEach(function (bounds, row) {
...
function barcodeCropFromBoxAndLine(img, findings, opts) {
	...
	var opr = null;
	if (findings.box instanceof Array &&
			opts.box instanceof Object && opts.box.adjustment instanceof Object && opts.box.adjustment instanceof Array)
	...
	if ("line" in findings && findings.line !== null &&
			opts.line instanceof Object && opts.line.adjustment instanceof Array) {
...
function colorCropStaged(img, stages) {
	...
	stages.forEach(function (stage) {
		...
		if (stage.color_deviation instanceof Array && stage.color_adjustment instanceof Array)
		...
		if (stage.crop_adjustment instanceof Array)
			bounds = logician.vectorBinaryOp("+", bounds, stage.crop_adjustment);
		if (stage.crop_overlay instanceof Array)
